...
> 本作の現行構成 (本編4 + 画面2 = 6 トラック) と各曲の使用シーンは [`BGM_PLAN.md`](./BGM_PLAN.md) に集約。本ガイドの 5 章以降では学習用に 2 トラック例で進めます。
...
```js
const IMG = {
  hall:    'images/image3.png',
  corridor:'images/image1.png',
  closeup: 'images/image2.png',
  gloves:  'images/image4.png',
  bowing:  'images/image5.png',
};
```
...
| `bgm` | `'bgm1'` か `'bgm2'` | **トラックを切り替えたい時だけ書く**。書かなければ前のトラック継続 |
...
- [ ] OP 終了またはスキップでタイトルに遷移、BGM1 が薄くフェードイン
